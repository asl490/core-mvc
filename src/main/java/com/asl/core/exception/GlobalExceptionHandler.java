package com.asl.core.exception;
...
import com.asl.core.exception.exception.BusinessRuleException;
import com.asl.core.exception.exception.DomainException;
import com.asl.core.exception.exception.InvalidEmailException;
import com.asl.core.exception.exception.InvalidInputException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolationException(DataIntegrityViolationException ex) {
        ...
        Map<String, String> errorPatterns = Map.of(
                ...
                "cannot insert the value null|null value", "NULL_VALUE_VIOLATION:Falta un valor obligatorio.",
                "data would be truncated|string or binary data",
                "VALUE_TOO_LONG:Un valor excede la longitud permitida.",
                "check constraint", "CHECK_CONSTRAINT_VIOLATION:Un valor no cumple con las reglas de validación.",
                "primary key constraint", "PRIMARY_KEY_VIOLATION:Ya existe un registro con esa clave primaria.");
